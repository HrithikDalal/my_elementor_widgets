...
/**
 * Base class to register Elementor Widget.
 */
abstract class Base extends Widget_Base {
	...
	public function __construct( $data = [], $args = null ) {
		...
		$this->name            = ( isset( $labels['name'] ) ) ? $labels['name'] : 'hrithik-widget-name';
		$this->title           = ( isset( $labels['title'] ) ) ? $labels['title'] : __( 'hrithik Widget Title', 'hrithik-features' );
		$this->icon            = ( isset( $labels['icon'] ) ) ? $labels['icon'] : 'eicon-apps';
		$this->categories      = ( isset( $labels['categories'] ) ) ? $labels['categories'] : [ 'hrithik' ];
