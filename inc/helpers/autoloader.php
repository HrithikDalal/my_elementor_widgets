 ...
 *
 * @package hrithik-featuers
 */

namespace Hrithik\Features\Inc\Helpers;
...
function autoloader( $resource = '' ) {
	...
	$resource_path  = false;
	$namespace_root = 'Hrithik\Features\\';
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( HRITHIK_FEATURES_PATH ), $directory, $file_name );
...
spl_autoload_register( '\Hrithik\Features\Inc\Helpers\autoloader' );
